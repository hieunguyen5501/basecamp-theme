 ...
 */
namespace Lof\LayeredNavigation\Model\ResourceModel\CloneCollection;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
	...
	public function getSearchCriteriaBuilder()
	{
		if ($this->searchCriteriaBuilder === null) {
			$this->searchCriteriaBuilder = ObjectManager::getInstance()
				->get('\Lof\LayeredNavigation\Model\Search\SearchCriteriaBuilder');
		}
	 ...
	 * @return void
	 */
	public function setSearchCriteriaBuilder(\Lof\LayeredNavigation\Model\Search\SearchCriteriaBuilder $object)
	{
